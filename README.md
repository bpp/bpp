...
[![Version](https://img.shields.io/badge/version-4.2.9-blue.svg)](https://github.com/bpp/bpp/releases/tag/v4.2.9)
...
BPP v4.2.9 now implements the following:
...
```bash
wget https://github.com/bpp/bpp/releases/download/v4.2.9/bpp-4.2.9-linux-x86_64.tar.gz
tar zxvf bpp-4.2.9-linux-x86_64.tar.gz
```

Or these commands if you using a Mac:

```bash
wget https://github.com/bpp/bpp/releases/download/v4.2.9/bpp-4.2.9-macos-x86_64.tar.gz
tar zxvf bpp-4.2.9-macos-x86_64.tar.gz
```

Or if you are using Windows, download and extract (unzip) the contents of this file:

```
https://github.com/bpp/bpp/releases/download/v4.2.9/bpp-4.2.9-win-x86_64.zip
```

Linux and Mac: You will now have the binary distribution in a folder called `bpp-4.2.9-linux-x86_64` or `bpp-4.2.9-macos-x86_64`. The binary file is located in the `bin` subfolder, i.e. `bin/bpp`. We recommend making a copy or a symbolic link to the binary in a folder included in your `$PATH`. 

Windows: You will now have the binary distribution in a folder called `bpp-4.2.9-win-x86_64`. The bpp executable is called `bpp.exe`.
...
```
wget https://github.com/bpp/bpp/archive/v4.2.9.tar.gz
...
The most up-to-date documentation of BPP is [bppDOC.pdf](https://github.com/bpp/bpp/releases/download/v4.2.9/bppDOC.pdf) distribution together with BPP.
