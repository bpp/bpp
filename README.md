...
[![Version](https://img.shields.io/badge/version-4.8.1-blue.svg)](https://github.com/bpp/bpp/releases/tag/4.8.1)
...
```bash
wget https://github.com/bpp/bpp/releases/download/4.8.1/bpp-4.8.1-linux-x86_64.tar.gz
...
```bash
wget https://github.com/bpp/bpp/releases/download/4.8.1/bpp-4.8.1-linux-ppc64le.tar.gz
...
```bash
wget https://github.com/bpp/bpp/releases/download/4.8.1/bpp-4.8.1-linux-aarch64.tar.gz
...
```bash
wget https://github.com/bpp/bpp/releases/download/4.8.1/bpp-4.8.1-macos-aarch64.tar.gz
...
```bash
wget https://github.com/bpp/bpp/releases/download/4.8.1/bpp-4.8.1-macos-x86_64.tar.gz
...
```
https://github.com/bpp/bpp/releases/download/4.8.1/bpp-4.8.1-win-x86_64.zip
```
...
```
wget https://github.com/bpp/bpp/archive/4.8.1.tar.gz
...
For an example of a DEFS-FILE see the [MSci generator notes](https://github.com/bpp/bpp/releases/download/4.8.1/msci-create.pdf)

More documentation regarding control files, will be available soon on the [wiki](https://github.com/bpp/bpp/wiki).

## Documentation

The most up-to-date documentation for BPP is now available through the [BPP Documentation Project](https://bpp.github.io/bpp-manual/). The original manual [bpp4DOC.pdf](https://github.com/bpp/bpp/releases/download/4.8.1/bpp4DOC.pdf) is found in the current BPP distribution.
