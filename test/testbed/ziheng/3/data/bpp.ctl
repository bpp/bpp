       ...
       seqfile = testbed/ziheng/3/data/test4s.txt
      Imapfile = testbed/ziheng/3/data/Imap.4s.txt
       outfile = testbed/ziheng/3/out/out.txt
      mcmcfile = testbed/ziheng/3/out/mcmc.txt
