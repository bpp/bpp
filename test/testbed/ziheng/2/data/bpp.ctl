       ...
       seqfile = testbed/ziheng/2/data/test4s.txt
      Imapfile = testbed/ziheng/2/data/Imap.4s.txt
       outfile = testbed/ziheng/2/out/out.txt
      mcmcfile = testbed/ziheng/2/out/mcmc.txt
...
speciesmodelprior = 1  * 0: uniform LH; 1:uniform rooted trees; 2: uniformSLH; 3: uniformSRooted
  ...
  species&tree = 4  A  B  C  D
                    2  1  2  2
                 (((A, B), C), D);
       diploid =    1  1  1  0       * 0: phased sequences, 1: unphased diploid sequences
