...
#times <- read.csv("~/bpp/examples/frogs/testtimes.txt", header =FALSE)
...
abs(.02 * .3  - (mean(time13) - .05))  / .06# Waiting time for coalescent event with three lineages, given there are three lineages at time .05
